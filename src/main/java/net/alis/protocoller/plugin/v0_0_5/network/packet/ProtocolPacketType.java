...
public class ProtocolPacketType implements MinecraftPacketType {
    ...
    public ProtocolPacketType(String packetName, @NotNull PacketType.State state, byte packetId) {
        this.packetState = state;
        this.packetId = packetId;
        switch (state) {
            case PLAY_CLIENTBOUND:this.packetName = "PacketPlayOut" + packetName; break;
            case PLAY_SERVERBOUND:this.packetName = "PacketPlayIn" + packetName; break;
