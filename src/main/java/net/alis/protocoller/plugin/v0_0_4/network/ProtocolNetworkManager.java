package net.alis.protocoller.plugin.v0_0_4.network;
...
public class ProtocolNetworkManager implements NetworkManager {
    ...
    public ProtocolDirection getProtocolDirection() {
        return ProtocolDirection.getById(((Enum<?>)this.handle.read(0, ClassAccessor.get().getProtocolDirectionEnum())).ordinal());
    }
