...
public class AttributeException extends ProtocollerException {
    ...
    public static class Builder implements ExceptionBuilderSource<Builder> {
        ...
        public CompletedException customMessage(String s) {
            return new CompletedException(new AttributeException(s + definedReason).mergeStackTracesIfNeed(elementsToMerge).changeStackTraceIfNeed(newStackTrace), showStackTrace, saveToFile, ignore);
        }
    }
