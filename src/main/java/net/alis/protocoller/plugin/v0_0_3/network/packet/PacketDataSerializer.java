...
public class PacketDataSerializer extends AccessedObject implements PacketDataContainer, Cloneable {
    ...
    public MinecraftPacketDataSerializer readOriginalDataSerializer(int index) {
        return new MinecraftPacketDataSerializer((Object) super.read(index, ClassAccessor.get().getPacketDataSerializerClass()));
    }
    ...
    public Entity readMinecraftEntity(int index) {
        return MinecraftReflection.entityFromMinecraftEntity(super.read(index, ClassAccessor.get().getMinecraftEntityClass()));
    }

    public PlayerAbilities readPlayerAbilities(int index) {
        return new PlayerAbilities(super.read(index, ClassAccessor.get().getPlayerAbilitiesClass()));
    }

    public BlockPosition readBlockPosition(int index) {
        return new BlockPosition(new BaseBlockPosition(super.read(index, ClassAccessor.get().getBlockPositionClass()), false));
    }

    public BaseBlockPosition readBaseBlockPosition(int index) {
        return new BaseBlockPosition(super.read(index, ClassAccessor.get().getBaseBlockPositionClass()), true);
    }

    public MinecraftKey readMinecraftKey(int index) {
        return new MinecraftKey((Object) super.read(0, ClassAccessor.get().getMinecraftKeyClass()));
    }

    public ChatComponent readIChatBaseComponent(int index) {
        return new ChatComponent(ChatSerializer.fromComponent(super.read(index, ClassAccessor.get().getIChatBaseComponentClass())));
    }
    ...
    public GameProfile readGameProfile(int index) {
        return new GameProfile(super.read(index, ClassAccessor.get().getGameProfileClass()));
    }

    public ServerPing readServerPing(int index) {
        return new ServerPing(super.read(0, ClassAccessor.get().getServerPingClass()));
    }
    ...
    public ItemStack readMinecraftItemStack(int index) {
        return MinecraftReflection.itemStackFromMinecraftItemStack(super.read(index, ClassAccessor.get().getMinecraftItemStackClass()));
    }
    ...
    public void writeIChatBaseComponent(int index, @NotNull ChatComponent component) {
        super.writeSpecify(index, ClassAccessor.get().getIChatBaseComponentClass(), component.asIChatBaseComponent());
    }
