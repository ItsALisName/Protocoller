...
public enum PacketLevel {
    ...
    PacketLoginOutDisconnect_1((byte) 1, ClassAccessor.get().getIChatBaseComponentClass()),
    ...
    ClientboundPlayerChatPacket_1((byte) 1, ClassAccessor.get().getIChatBaseComponentClass(), Optional.class, int.class, ClassAccessor.get().getChatSenderClass(), Instant.class, ClassAccessor.get().getMinecraftEncryptionSignatureDataClass()),
    ...
    ClientboundPlayerChatPacket_3((byte) 3, UUID.class, int.class, ClassAccessor.get().getMessageSignatureClass(), ClassAccessor.get().getSignedMessageBodyPackedClass(), ClassAccessor.get().getIChatBaseComponentClass(), ClassAccessor.get().getFilterMaskClass(), ClassAccessor.get().getChatBoundNetworkClass()),
    ClientboundPingPacket_1((byte) 1, int.class),
    ClientboundPlayerCombatEndPacket_1((byte) 1, int.class, int.class),
    ClientboundPlayerCombatKillPacket_1((byte) 1, int.class, int.class, ClassAccessor.get().getIChatBaseComponentClass()),
    ClientboundSetActionBarTextPacket_1((byte) 1, ClassAccessor.get().getIChatBaseComponentClass()),
    ...
    ClientboundSetSubtitleTextPacket_1((byte) 1, ClassAccessor.get().getIChatBaseComponentClass()),
    ClientboundSetTitleTextPacket_1((byte) 1, ClassAccessor.get().getIChatBaseComponentClass()),
    ...
    ClientboundLevelChunkPacketData_1((byte) 1, ClassAccessor.get().getMinecraftChunkClass()),
    ClientboundLevelChunkWithLightPacket_1((byte) 1, ClassAccessor.get().getMinecraftChunkClass(), ClassAccessor.get().getLightEngineClass(), BitSet.class, BitSet.class, boolean.class),
    ...
    ClientboundDisguisedChatPacket_1((byte) 1, ClassAccessor.get().getIChatBaseComponentClass(), ClassAccessor.get().getChatBoundNetworkClass()),
    ...
    PacketPlayOutChat_1((byte) 1, ClassAccessor.get().getIChatBaseComponentClass(), int.class),
    PacketPlayOutChat_2((byte) 2, ClassAccessor.get().getIChatBaseComponentClass(), ClassAccessor.get().getChatMessageTypeEnum()),
    PacketPlayOutChat_3((byte) 3, ClassAccessor.get().getIChatBaseComponentClass(), ClassAccessor.get().getChatMessageTypeEnum(), UUID.class),
