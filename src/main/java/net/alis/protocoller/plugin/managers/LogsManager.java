...
public class LogsManager {
    ...
    public final void sendPreloadingFinishedMessage(String pluginVersion) {
        ...
        logger.log(Level.INFO, "[*]  * Server Version: " + IProtocolAccess.get().getServer().getVersion().asString() + "(Protocol: " + IProtocolAccess.get().getServer().getVersion().getProtocol() + ")");
        logger.log(Level.INFO, "[*]  * Plugin Version: " + pluginVersion);
        logger.log(Level.INFO, "[*]  * Java Version: " + ApproximateData.get().getJavaVersion());
        logger.log(Level.INFO, "[*]  * JDK Version: " + ApproximateData.get().getJdkVersion());
        logger.log(Level.INFO, "[*]  * OS Name/Architecture: " + ApproximateData.get().getOsName() + " / " + ApproximateData.get().getOsArchitecture());
        logger.log(Level.INFO, "[*]  * OS Version: " + ApproximateData.get().getOsVersion());
        logger.log(Level.INFO, "[*]============================================================[*]");
    }
