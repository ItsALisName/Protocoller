...
public class PacketDataSerializer extends AccessedObject implements PacketDataContainer, Cloneable {
    ...
    public MinecraftPacketDataSerializer readOriginalDataSerializer(int index) {
        return new MinecraftPacketDataSerializer((Object) super.read(index, ClassesContainer.get().getPacketDataSerializerClass()));
    }
    ...
    public Entity readMinecraftEntity(int index) {
        return MinecraftReflection.entityFromMinecraftEntity(super.read(index, ClassesContainer.get().getMinecraftEntityClass()));
    }

    public PlayerAbilities readPlayerAbilities(int index) {
        return new PlayerAbilities(super.read(index, ClassesContainer.get().getPlayerAbilitiesClass()));
    }

    public BlockPosition readBlockPosition(int index) {
        return new BlockPosition(new BaseBlockPosition(super.read(index, ClassesContainer.get().getBlockPositionClass()), false));
    }

    public BaseBlockPosition readBaseBlockPosition(int index) {
        return new BaseBlockPosition(super.read(index, ClassesContainer.get().getBaseBlockPositionClass()), true);
    }

    public MinecraftKey readMinecraftKey(int index) {
        return new MinecraftKey((Object) super.read(0, ClassesContainer.get().getMinecraftKeyClass()));
    }

    public ChatComponent readIChatBaseComponent(int index) {
        return new ChatComponent(ChatSerializer.fromComponent(super.read(index, ClassesContainer.get().getIChatBaseComponentClass())));
    }
    ...
    public GameProfile readGameProfile(int index) {
        return new GameProfile(super.read(index, ClassesContainer.get().getGameProfileClass()));
    }

    public ServerPing readServerPing(int index) {
        return new ServerPing(super.read(0, ClassesContainer.get().getServerPingClass()));
    }
    ...
    public ItemStack readMinecraftItemStack(int index) {
        return MinecraftReflection.itemStackFromMinecraftItemStack(super.read(index, ClassesContainer.get().getMinecraftItemStackClass()));
    }
    ...
    public void writeBaseBlockPosition(int index, @NotNull BaseBlockPosition position) {
        super.writeSpecify(index, ClassesContainer.get().getBaseBlockPositionClass(), position.createOriginal());
    }
    ...
    public void writeMinecraftItemStack(int index, ItemStack stack) {
        super.writeSpecify(index,ClassesContainer.get().getMinecraftItemStackClass(), MinecraftReflection.getMinecraftItemStack(stack));
    }
    ...
    public void writeBlockPosition(int index, @NotNull BlockPosition position) {
        super.writeSpecify(index, ClassesContainer.get().getBlockPositionClass(), position.createOriginal());
    }
    ...
    public void writeIChatBaseComponent(int index, @NotNull ChatComponent component) {
        super.writeSpecify(index, ClassesContainer.get().getIChatBaseComponentClass(), component.asIChatBaseComponent());
    }
    ...
    public void writeMinecraftEntity(int index, Entity entity) {
        super.writeSpecify(index, ClassesContainer.get().getMinecraftEntityClass(), MinecraftReflection.getMinecraftEntity(entity));
    }
