...
public class KeyBuilder implements Cloneable {
    ...
    private KeyBuilder(@NotNull KeyBuilder keyBuilder) {
    ...
    public static boolean isSubKeyOf(@NotNull String parentKey, String subKey, char separator) {
    ...
    public static @NotNull String getIndents(@NotNull String key, char separator) {
