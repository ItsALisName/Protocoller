...
public class MobEffect implements ObjectSample {
    ...
    public MobEffect(Object original) {
        ...
        if(accessor.read(0, ClassesContainer.INSTANCE.getMobEffectClass()) != null) {
            this.hiddenEffect = new MobEffect((Object) accessor.read(0, ClassesContainer.INSTANCE.getMobEffectClass()));
        } else {
    ...
    public Object createOriginal() {
        return Reflection.callConstructor(
                Reflection.getConstructor(ClassesContainer.INSTANCE.getMobEffectClass(), ClassesContainer.INSTANCE.getMobEffectListClass(), int.class, int.class, boolean.class, boolean.class, boolean.class),
