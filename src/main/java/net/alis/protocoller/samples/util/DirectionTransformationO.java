...
public enum DirectionTransformationO {
    ...
    public static @Nullable DirectionTransformationO getById(int id) {
        Utils.checkClassSupportability(clazz(), "DirectionTransformationO", false);
    ...
    public static Class<?> clazz() {
        return ClassAccessor.get().getPointOEnum();
    }
}
