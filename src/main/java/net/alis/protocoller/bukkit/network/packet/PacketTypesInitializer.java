...
public class PacketTypesInitializer extends PacketType {
    ...
    public static void init() {
        ...
        Play.Server.LEVEL_CHUNK_WITH_LIGHT_PACKET = new ProtocollerPacketType("LevelWithLightPacket", State.CLIENTBOUND, (byte) 32); packets.add(Play.Server.LEVEL_CHUNK_WITH_LIGHT_PACKET);
