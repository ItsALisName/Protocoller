...
public enum ConstructorLevelIndicator {
    ...
    PacketPlayInBlockPlace_1((byte) 1, ClassesContainer.INSTANCE.getMinecraftItemStackClass()),
    ...
    PacketPlayInRecipeSettings_1((byte) 1, ClassesContainer.INSTANCE.getRecipeBookTypeEnum(), boolean.class, boolean.class),
    PacketPlayOutBlockAction_1((byte) 1, ClassesContainer.INSTANCE.getBlockPositionClass(), ClassesContainer.INSTANCE.getMinecraftBlockClass(), int.class, int.class),
    ...
    PacketPlayOutCommands_1((byte) 1, ClassesContainer.INSTANCE.getRootCommandNodeClass()),
    PacketPlayOutBed_1((byte) 1, ClassesContainer.INSTANCE.getEntityHumanClass(), ClassesContainer.INSTANCE.getBlockPositionClass()),
    PacketPlayOutBlockBreakAnimation_1((byte) 1, int.class, ClassesContainer.INSTANCE.getBlockPositionClass(), int.class),
    PacketPlayOutBlockBreak_1((byte) 1, ClassesContainer.INSTANCE.getBlockPositionClass(), ClassesContainer.INSTANCE.getIBlockDataClass(), ClassesContainer.INSTANCE.getPlayerDigTypeEnum(), boolean.class, String.class),
    PacketPlayOutBlockChange_1((byte) 1, ClassesContainer.INSTANCE.getMinecraftWorldClass(), ClassesContainer.INSTANCE.getBlockPositionClass()),
    PacketPlayOutBlockChange_2((byte) 2, ClassesContainer.INSTANCE.getIBlockAccessClass(), ClassesContainer.INSTANCE.getBlockPositionClass()),
    PacketPlayOutBlockChange_3((byte) 3, ClassesContainer.INSTANCE.getBlockPositionClass(), ClassesContainer.INSTANCE.getIBlockDataClass()),
    ...
    PacketPlayOutChat_1((byte) 1, ClassesContainer.INSTANCE.getIChatBaseComponentClass(), int.class),
    PacketPlayOutChat_2((byte) 2, ClassesContainer.INSTANCE.getIChatBaseComponentClass(), ClassesContainer.INSTANCE.getChatMessageTypeEnum()),
    PacketPlayOutChat_3((byte) 3, ClassesContainer.INSTANCE.getIChatBaseComponentClass(), ClassesContainer.INSTANCE.getChatMessageTypeEnum(), UUID.class),
    ...
    PacketPlayOutCamera_1((byte) 1, ClassesContainer.INSTANCE.getMinecraftEntityClass()),
    PacketPlayOutBoss_1((byte) 1, ClassesContainer.INSTANCE.getBossActionEnum(), ClassesContainer.INSTANCE.getBossBattleClass()),
    PacketPlayOutBoss_2((byte) 2, UUID.class, ClassesContainer.INSTANCE.getBossActionInterface()),
