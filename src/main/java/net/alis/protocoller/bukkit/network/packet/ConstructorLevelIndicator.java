...
public enum ConstructorLevelIndicator {
    ...
    PacketPlayInBlockDig_2((byte) 1, ClassesContainer.INSTANCE.getPlayerDigTypeEnum(), ClassesContainer.INSTANCE.getBlockPositionClass(), ClassesContainer.INSTANCE.getDirectionEnum(), int.class),
    ...
    PacketPlayInEntityAction_1((byte) 1, ClassesContainer.INSTANCE.getMinecraftEntityClass(), int.class),
