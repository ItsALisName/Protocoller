...
public class ServerData {
    ...
    public static class Serializer implements JsonDeserializer<ServerData>, JsonSerializer<ServerData> {
        ...
        @Override
        public JsonElement serialize(ServerData version, Type type, JsonSerializationContext jsonSerializationContext) {
    ...
    public Object createOriginal() {
        return Reflection.callConstructor(
                Reflection.getConstructor(ClassesContainer.INSTANCE.getServerDataClass(), String.class, int.class),
