...
public class PacketPlayInPositionLook implements Packet {
    ...
    public PacketPlayInPositionLook(PacketDataSerializer packetData) {
    ...
    public PacketPlayInPositionLook(double x, double y, double z, float yaw, float pitch, boolean onGround) {
        this.packetData = new PacketDataSerializer(PacketCreator.get(getPacketType()).create(null, x, y, z, yaw, pitch, onGround));
        this.x = x;
        this.y = y;
        this.z = z;
        this.yaw = yaw;
